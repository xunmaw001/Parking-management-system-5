          ...
          <el-form-item class="input" v-if="ruleForm.ruchangshijian" label="入场时间" prop="ruchangshijian">
              <el-input v-model="ruleForm.ruchangshijian" 
                placeholder="入场时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入场备注" prop="ruchangbeizhu">
          <el-input v-model="ruleForm.ruchangbeizhu" 
              placeholder="入场备注" clearable  :readonly="ro.ruchangbeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入场备注" prop="ruchangbeizhu">
              <el-input v-model="ruleForm.ruchangbeizhu" 
                placeholder="入场备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ruchangshijian = true;
            continue;
	            	            ...
	            	            if(o=='ruchangbeizhu'){
            this.ruleForm.ruchangbeizhu = obj[o];
	    this.ro.ruchangbeizhu = true;
            continue;
          }
	            	            if(o=='yonghuming'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.shouji = json.shouji
                                  		...
                                  		if(json.chepaihaoma!=''&&json.chepaihaoma){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ruchangtingche/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ruchangtingcheCrossAddOrUpdateFlag = false;
                  this.parent.search();
