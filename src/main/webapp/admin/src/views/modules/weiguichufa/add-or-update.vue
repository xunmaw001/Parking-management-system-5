        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="违规内容" prop="weiguineirong">
          <el-input v-model="ruleForm.weiguineirong" 
              placeholder="违规内容" clearable  :readonly="ro.weiguineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="违规内容" prop="weiguineirong">
              <el-input v-model="ruleForm.weiguineirong" 
                placeholder="违规内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="处罚内容" prop="chufaneirong">
          <el-input v-model="ruleForm.chufaneirong" 
              placeholder="处罚内容" clearable  :readonly="ro.chufaneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="处罚内容" prop="chufaneirong">
              <el-input v-model="ruleForm.chufaneirong" 
                placeholder="处罚内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="处罚金额" prop="chufajine">
          <el-input v-model="ruleForm.chufajine" 
              placeholder="处罚金额" clearable  :readonly="ro.chufajine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="处罚金额" prop="chufajine">
              <el-input v-model="ruleForm.chufajine" 
                placeholder="处罚金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  weiguineirong: [
                            { required: true, message: '违规内容不能为空', trigger: 'blur' },
                                    	                                                              ],
                  chufaneirong: [
