  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.18);borderRadius:15px">
        <h1 class="h1" style="color:rgba(64, 158, 255, 1);fontSize:28px;">停车场管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.chepaihaoma" class="input" type="text" placeholder="车牌号码">
			   </div>
			 </div> -->
			<el-form-item label="车牌号码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.chepaihaoma" autocomplete="off" placeholder="车牌号码" type="text" />
			</el-form-item>
